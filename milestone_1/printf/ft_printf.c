...
/* This function is an almost complete simulation of the printf function.
   Using variadic functions to handle a variable number of arguments.
   It handles the formatted output for various data types such as integers,
   pointers, and strings, depending on the format specifiers. */
