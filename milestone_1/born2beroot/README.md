...
- [Índice](#índice)
	- [1- Descargar ISO de Debian e instalar Virtual Box](#1--descargar-iso-de-debian-e-instalar-virtual-box)
	- [2- Instalación VM de Debian](#2--instalación-vm-de-debian)
	- [3- Instalación Debian](#3--instalación-debian)
	- [4 Configuración de la máquina virtual ⚙️](#4-configuración-de-la-máquina-virtual-️)
		- [Ya tenemos todo listo para empezar a configurar nuestra máquina virtual Debian❗️](#ya-tenemos-todo-listo-para-empezar-a-configurar-nuestra-máquina-virtual-debian️)
		- [4.1 - Instalación de sudo y configuración de usuarios y grupos 👤](#41---instalación-de-sudo-y-configuración-de-usuarios-y-grupos-)
		- [4.2 - Instalación y configuración SSH 📶](#42---instalación-y-configuración-ssh-)
	...
	- [5- Script 🚨](#5--script-)
		...
		- [5-2 Núcleos físicos](#5-2-núcleos-físicos)
		- [5-3 Núcleos virtuales](#5-3-núcleos-virtuales)
		- [5-4 Memoria RAM](#5-4-memoria-ram)
		- [5-5 Memoria del disco](#5-5-memoria-del-disco)
		- [5-6 Porcentaje uso de CPU](#5-6-porcentaje-uso-de-cpu)
		- [5-7 Último reinicio](#5-7-último-reinicio)
		- [5-8 Uso LVM](#5-8-uso-lvm)
		- [5-9 Conexiones TCP](#5-9-conexiones-tcp)
		- [5-10 Número de usuarios](#5-10-número-de-usuarios)
		- [5-11 Dirección IP y MAC](#5-11-dirección-ip-y-mac)
		- [5-12 Número de comandos ejecutados con sudo](#5-12-número-de-comandos-ejecutados-con-sudo)
		- [5-13 Resultado total del script](#5-13-resultado-total-del-script)
	- [6- Crontab ⏰](#6--crontab-)
	...
	- [8- Bonus ⭐️](#8--bonus-️)
		...
		- [Mariadb](#mariadb)
		- [PHP](#php)
		- [Configuración WordPress](#configuración-wordpress)
		- [8.3 - Servicio adicional ➕](#83---servicio-adicional-)
		- [LiteSpeed ⚡️](#litespeed-️)
- [](#)
- [Este tutorial ha llevado mucho trabajo, si crees que te ha sido útil agradeceria mucho starred 🌟 para que así se comparta y pueda ayudar a más estudiantes 👨🏻‍🎓❤️](#este-tutorial-ha-llevado-mucho-trabajo-si-crees-que-te-ha-sido-útil-agradeceria-mucho-starred--para-que-así-se-comparta-y-pueda-ayudar-a-más-estudiantes-️)
	- [9- Hoja de corrección ✅](#9--hoja-de-corrección-)
	- [9-1 Respuestas de la evaluación 💯](#9-1-respuestas-de-la-evaluación-)
		- [▪️ Qué es una máquina virtual❓](#️-qué-es-una-máquina-virtual)
		- [▪️ Porque has escogido Debian❓](#️-porque-has-escogido-debian)
		- [▪️ Diferencias básicas entre Rocky y Debian](#️-diferencias-básicas-entre-rocky-y-debian)
		- [▪️ Cuál es el propósito de las máquinas virtuales❓](#️-cuál-es-el-propósito-de-las-máquinas-virtuales)
		- [▪️ Diferencias entre apt y aptitude ↙️](#️-diferencias-entre-apt-y-aptitude-️)
		- [▪️ Qué es APPArmor❓](#️-qué-es-apparmor)
		- [▪️ Qué es LVM❓](#️-qué-es-lvm)
	- [9-2 Comandos de la evaluación ⌨️](#9-2-comandos-de-la-evaluación-️)
	- [10- Tester 🆗](#10--tester-)
- [Contacto 📥](#contacto-)
		- [Contacta conmigo si crees que puedo mejorar el tutorial! Puede ayudar a futuros estudiantes! 😁](#contacta-conmigo-si-crees-que-puedo-mejorar-el-tutorial-puede-ayudar-a-futuros-estudiantes-)
- [Quizás pueda interesarte!](#quizás-pueda-interesarte)
		- [- Para ver mi progresion en el common core 42 ↙️](#--para-ver-mi-progresion-en-el-common-core-42-️)
		- [- Mi perfil en la intranet de 42 ↙️](#--mi-perfil-en-la-intranet-de-42-️)
