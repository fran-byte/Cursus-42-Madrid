...
si la primera cadena está oculta en la segunda, de lo contrario, muestra 0 seguido de un
salto de línea.

Sean s1 y s2 cadenas. Decimos que s1 está oculta en s2 si es posible encontrar cada carácter
de s1 en s2, en el mismo orden en que aparecen en s1. Además, la cadena vacía está oculta
en cualquier cadena.
